...
def main(page: ft.Page):
    ...
    page.add(
        ft.Text(
            "LineChart 折线图组件", size=28, weight=ft.FontWeight.BOLD, color="#1f2937"
        ),
        ...
        ft.Text(
            "data=[{'x':1,'y':3}, {'x':2,'y':5}, {'x':3,'y':2}, {'x':4,'y':7}, {'x':5,'y':4}]",
            size=12,
            color="#6b7280",
        ),
        LineChart(
        ...
        ft.Divider(),
        # 5. 不显示网格
        ft.Text("5. 无网格、无提示", size=16, weight=ft.FontWeight.BOLD),
        LineChart(
        ...
        ft.Divider(),
        # 7. 大量数据
        ft.Text("7. 大量数据 (50个点)", size=16, weight=ft.FontWeight.BOLD),
        LineChart(
